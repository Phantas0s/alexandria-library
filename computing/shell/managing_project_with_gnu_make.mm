...
<node CREATED="1651328472793" ID="ID_1329643860" MODIFIED="1651404466538" TEXT="Automatic Variables">
<icon BUILTIN="full-2"/>
<node CREATED="1651404468990" ID="ID_1688771754" MODIFIED="1651404478008" TEXT="Set by make after rule is matched"/>
<node CREATED="1651404479139" ID="ID_1205650320" MODIFIED="1651404486302" TEXT="Provide access to elements from">
<node CREATED="1651404486457" ID="ID_909349729" MODIFIED="1651404487431" TEXT="target"/>
<node CREATED="1651404641186" ID="ID_228758536" MODIFIED="1651404643844" TEXT="prerequisites"/>
</node>
<node CREATED="1651404645810" ID="ID_1540404586" MODIFIED="1651404661774" TEXT="Seven core automatic variables">
<node CREATED="1651404662147" ID="ID_1136183852" MODIFIED="1651404663967" TEXT="$@">
<node CREATED="1651404664418" ID="ID_1779004539" MODIFIED="1651404669950" TEXT="The filename representing the target"/>
</node>
<node CREATED="1651404672090" ID="ID_127512706" MODIFIED="1651404677252" TEXT="$%">
<node CREATED="1651404677554" ID="ID_1213728455" MODIFIED="1651404684319" TEXT="The filename of an archive member specification"/>
</node>
<node CREATED="1651404685947" ID="ID_809844703" MODIFIED="1651404691015" TEXT="$&lt;">
<node CREATED="1651404691250" ID="ID_992720267" MODIFIED="1651404696454" TEXT="Filename of the first prerequisite"/>
</node>
<node CREATED="1651404699130" ID="ID_959368178" MODIFIED="1651404701854" TEXT="$^">
<node CREATED="1651404702023" ID="ID_1974678627" MODIFIED="1651404709414" TEXT="Filename of all prerequisites"/>
<node CREATED="1651404709763" ID="ID_1391472983" MODIFIED="1651404715447" TEXT="Separated by spaces"/>
<node CREATED="1651404715858" ID="ID_980134081" MODIFIED="1651404722724" TEXT="Dupllicate filenames removed"/>
</node>
<node CREATED="1651404726250" ID="ID_957503920" MODIFIED="1651404738470" TEXT="$+">
<node CREATED="1651404728249" ID="ID_142102290" MODIFIED="1651404731708" TEXT="Like $^"/>
<node CREATED="1651404732001" ID="ID_257461479" MODIFIED="1651404743575" TEXT="Duplicate filenames not removed"/>
</node>
<node CREATED="1651404849923" ID="ID_969439783" MODIFIED="1651404852431" TEXT="$*">
<node CREATED="1651404852794" ID="ID_190973221" MODIFIED="1651404856924" TEXT="Stem of the target filename"/>
<node CREATED="1651404868713" ID="ID_37215543" LINK="#ID_696791490" MODIFIED="1651404903076" TEXT="Should be used only inside of pattern rules"/>
</node>
</node>
<node CREATED="1651405773136" ID="ID_763464931" MODIFIED="1651405779885" TEXT="Two variants for compatibility"/>
<node CREATED="1651405784935" ID="ID_8292814" MODIFIED="1651405797747" TEXT="... but better using functions">
<node CREATED="1651405787664" ID="ID_1518925434" MODIFIED="1651405795360" TEXT="dir">
<font ITALIC="true" NAME="SansSerif" SIZE="12"/>
</node>
<node CREATED="1651405793472" ID="ID_1340681749" MODIFIED="1651405796050" TEXT="nodir">
<font ITALIC="true" NAME="SansSerif" SIZE="12"/>
</node>
</node>
</node>
...
<node CREATED="1651328746458" ID="ID_1085248456" MODIFIED="1651330089000" TEXT="VPATH variable">
...
<node CREATED="1651330089363" ID="ID_303270012" MODIFIED="1651330092881" TEXT="vpath directive">
...
<node CREATED="1651330167355" ID="ID_696791490" MODIFIED="1651404899518" TEXT="Pattern Rules">
<font NAME="SansSerif" SIZE="12"/>
<icon BUILTIN="full-4"/>
...
<node CREATED="1651331185017" ID="ID_1897808462" MODIFIED="1651331559898" TEXT="Suffix Rules">
<icon BUILTIN="full-3"/>
...
<node CREATED="1651406464899" ID="ID_822551209" MODIFIED="1651406472743" TEXT="Where Variables Come From">
<icon BUILTIN="full-5"/>
<node CREATED="1651406512843" ID="ID_1281272073" MODIFIED="1651406517535" TEXT="Variables can come from the source">
<node CREATED="1651406517747" ID="ID_1602560469" MODIFIED="1651406518783" TEXT="File">
<node CREATED="1651406525843" ID="ID_1530585326" MODIFIED="1651406528615" TEXT="makefile"/>
<node CREATED="1651406528963" ID="ID_1994562661" MODIFIED="1651406536079" TEXT="External files (see include)"/>
</node>
<node CREATED="1651406537979" ID="ID_786573895" MODIFIED="1651406539631" TEXT="Command Line">
<node CREATED="1651406547219" ID="ID_1617736342" MODIFIED="1651406574017" TEXT="Example">
<icon BUILTIN="wizard"/>
<node CREATED="1651406548643" ID="ID_1546848725" MODIFIED="1651406572691" TEXT="$ make CFLAGS=-g CPPFLLAGS=&apos;-DBSD -DDEBUG&apos;">
<font ITALIC="true" NAME="SansSerif" SIZE="12"/>
</node>
<node CREATED="1651406597683" ID="ID_92118635" MODIFIED="1651406599446" TEXT="Override">
<node CREATED="1651406599827" ID="ID_702973822" MODIFIED="1651406604479" TEXT="Any value from the environment"/>
<node CREATED="1651406604810" ID="ID_920173943" MODIFIED="1651406615382" TEXT="Any assignment in makefile"/>
</node>
<node CREATED="1651406621914" ID="ID_465714428" MODIFIED="1651406630030" TEXT="Can use := (simple) or = (recursive)"/>
<node CREATED="1651406641234" ID="ID_1252436563" MODIFIED="1651406654767" TEXT="Use override directive in makefile">
<node CREATED="1651406654963" ID="ID_139037227" MODIFIED="1651406659078" TEXT="Bypass the command arg"/>
<node CREATED="1651406786404" ID="ID_1339174596" MODIFIED="1651406798604" TEXT="Example">
<icon BUILTIN="wizard"/>
<node CREATED="1651406787684" ID="ID_346003694" MODIFIED="1651406796890" TEXT="override LDFLAGS = -EB">
<font ITALIC="true" NAME="SansSerif" SIZE="12"/>
</node>
</node>
</node>
...
<node CREATED="1651406666730" ID="ID_1131478510" MODIFIED="1651406668359" TEXT="Environment">
<node CREATED="1651406670778" ID="ID_1014841174" MODIFIED="1651406683415" TEXT="All variables from environment "/>
<node CREATED="1651406684258" ID="ID_1937752532" MODIFIED="1651406690934" TEXT="... automatically defined when make starts"/>
<node CREATED="1651406702850" ID="ID_43338391" MODIFIED="1651406715830" TEXT="Any other declaration override them">
<node CREATED="1651406716458" ID="ID_987890615" MODIFIED="1651406719246" TEXT="Little precedence"/>
</node>
<node CREATED="1651406731778" ID="ID_1364505627" MODIFIED="1651406737639" TEXT="If make used recursively">
<node CREATED="1651406739514" ID="ID_1512301761" MODIFIED="1651406749398" TEXT="Some variables are passed to childs"/>
<node CREATED="1651406756354" ID="ID_791454883" MODIFIED="1651406762510" TEXT="By default, only var from environment"/>
<node CREATED="1651406762858" ID="ID_111229520" MODIFIED="1651406775409" TEXT="Can use directive export to explicitely pass them"/>
<node CREATED="1651406800940" ID="ID_1861196663" MODIFIED="1651406809893" TEXT="Example">
<icon BUILTIN="wizard"/>
<node CREATED="1651406802468" ID="ID_1254797358" MODIFIED="1651406811195" TEXT="export CLASSPATH := path">
<font ITALIC="true" NAME="SansSerif" SIZE="12"/>
</node>
</node>
<node CREATED="1651406817964" ID="ID_1407220460" MODIFIED="1651406823685" TEXT="Use single export to export all vars"/>
<node CREATED="1651406848820" ID="ID_189481906" MODIFIED="1651406857320" TEXT="Can even export var with invalid character for shell vars!"/>
<node CREATED="1651406896877" ID="ID_253532143" MODIFIED="1651406911982" TEXT="Can prevent passing env var to child with unexport directive"/>
</node>
<node CREATED="1651406928467" ID="ID_271828661" MODIFIED="1651406964518" TEXT="Conditional assignment operator works great with env var"/>
</node>
<node CREATED="1651407071564" ID="ID_736109184" MODIFIED="1651407080080" TEXT="Automatic">
<node CREATED="1651407075474" ID="ID_18069188" MODIFIED="1651407094072" TEXT="make creates automatic var before executing">
<node CREATED="1651407094266" ID="ID_1047540437" MODIFIED="1651407096327" TEXT="command script"/>
<node CREATED="1651407096659" ID="ID_263267701" MODIFIED="1651407097463" TEXT="rule"/>
</node>
</node>
</node>
<node CREATED="1651407139324" ID="ID_356315393" MODIFIED="1651407142816" TEXT="Careful with env var">
<node CREATED="1651407142987" ID="ID_1686037309" MODIFIED="1651407151176" TEXT="Less portability"/>
<node CREATED="1651407151555" ID="ID_788084662" MODIFIED="1651407161512" TEXT="Should have some default value using operator ?="/>
<node CREATED="1651407163771" ID="ID_1963970440" MODIFIED="1651407168221" TEXT="... directly in makefile"/>
</node>
</node>
<node CREATED="1651407187602" ID="ID_1534384045" MODIFIED="1651407197457" TEXT="Conditional and include Processing">
<icon BUILTIN="full-6"/>
</node>
</node>
</node>
